...
# ** 함수 정의 **
#  1. 기본 함수 문법
# def 함수명(parameter1, parameter2, ...):   # 괄호안 = 입력값
#     실행문                                 # 실행
#     return 반환값                          # 결과값
...
def sub_two_value(x: int, y: int):  # : int = 힌트 # 2줄 떼면 밑줄 사라짐
    n = x-y
    return n
a, b = 15, 20
...
# def test(a=1, b, c):          # (X)
# def test(a, b=2, c):          # (X)
# def test(a=1, b=2, c):        # (X)    # 설정할 거를 뒤쪽으로 뺴줘야함(오른쪽)
