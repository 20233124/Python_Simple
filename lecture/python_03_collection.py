...
list_a = [1, 2, 3]  # 1, 한칸 2, 한칸 3 한칸 0 1 2, -3 -2 -1
list_b = []
list_c = ["chosun", 5, 3.14, [1, 2, 3]]  # 4칸 list안 list도 한칸으로 계산 * 2차원리스트
...
# a = list_d[0]
# b = list_d[1]    # JAVA, C에선 이렇게 unpacking 함
# c = list_d[2]
...
#  - sort() : 원본값 자체를 정렬(원본값 상실)  x 위험해서 사용 x
